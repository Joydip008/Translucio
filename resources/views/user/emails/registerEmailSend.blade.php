        ...
        <table style="margin: 0;width:100%;">
            <tr>
                ...
                <td>
                    ...
                    font-size: 20px;
                    font-weight: 500;
                    line-height: 34px;">{{$data['name']}},</p>
                        <div style="height:10px"></div>
                    <p style="color: #535353;
                    margin: 0;
                    font-size: 16px;">Thank you for signing up. Please click the button below to confirm your email & registration !</p>

                    </h2>
                    <div style="height:20px"></div>
                    
                    <a href="{{url('/active/'.$data['token'])}}" style="background: #EB3142;
                    ...
                    border-radius: 26px;
                    height: 31px;
                    line-height: 31px;">Confirm Now</a>
                </td>
                <td style="width:33px;"></td>
            </tr>
        </table>
