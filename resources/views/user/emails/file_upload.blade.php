        ...
        <table style="height: 113px;background-color:#6a69e8;margin: 0;width:100%;">
            <tr>
                ...
                <td style="vertical-align: center;font-size: 30px;
                  ...
                  color: #ffffff;text-align: center;">Transluc.io - Please See your Files</td>
                <td style="width:25px;"></td>
            </tr>
        </table>
        ...
        <table style="margin: 0;width:100%;">
            <tr>
                ...
                <td>
                    ...
                    margin: 0;
                    font-size: 16px;">Thank you for use TRANSLUCIO! Your file is successfully translated ! Enjoy with TRANSLUCIO.</p>
