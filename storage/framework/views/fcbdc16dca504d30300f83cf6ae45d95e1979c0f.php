        ...
        <table style="height: 113px;background-color:#6a69e8;margin: 0;width:100%;">
            <tr>
                ...
                <td style="vertical-align: center;font-size: 30px;
                  ...
                  color: #ffffff;text-align: center;">Transluc.io - Please Look at this</td>
                <td style="width:25px;"></td>
            </tr>
        </table>
        ...
        <table style="margin: 0;width:100%;">
            <tr>
                ...
                <td>
                    ...
                    font-size: 20px;
                    font-weight: 500;
                    line-height: 34px;">Hello Friend,</p>
                        <div style="height:10px"></div>
                    <p style="color: #535353;
                    margin: 0;
                    font-size: 16px;">Check this and translate what you want own your way.</p>

                    </h2>
                    <div style="height:20px"></div>
                   
                    <a href="<?php echo e(route('register',$code)); ?>" style="background: #EB3142; 
        ...
        <table style="margin: 0;width:100%;">
            <tr>
                ...
                <td>
                    ...
                    display: inline-block;
                    line-height: 50px;">
                        © 2019-2020 Transluc.io. All Rights Reserved.
...
</html><?php /**PATH E:\XAMPP1\htdocs\translucio\translucio\resources\views/user/emails/share_friend_by_mail.blade.php ENDPATH**/ ?>