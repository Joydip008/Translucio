...
<?php $__env->startSection('content'); ?>
              ...
              <div class="box-tools pull-right">
                <div class="search-fleld">
                    <div class="search_sec">
                        <form action="<?php echo e(route('credit_purchase_invoice_list')); ?>" method="post">
                        <?php echo csrf_field(); ?>
  ...
  <table class="table">
    ...
    <!--Table body-->
    <tbody>
    <?php $__currentLoopData = $InvoiceDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <tr>
        <td><?php echo e($Invoice['invoice_number']); ?></td>
        <td><?php echo e($Invoice['created_at']); ?></td>
        <?php if(empty($Invoice['profile_image'])): ?>
          <td><a href="javacsript:;"><img src="<?php echo e(asset('assets/images/user.png')); ?>" hieght="30" width="30" class="m-righ"><?php echo e($Invoice['customer_name']); ?></a></td>
        <?php else: ?>
          <td><a href="javacsript:;"><img src="<?php echo e(asset('assets/upload/user/'.$Invoice['profile_image'])); ?>" hieght="30" width="30" class="m-righ"><?php echo e($Invoice['customer_name']); ?></a></td> 
        <?php endif; ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\XAMPP1\htdocs\translucio\translucio\resources\views/admin/creditPurchaseInvoice/credit_purchase_invoice.blade.php ENDPATH**/ ?>