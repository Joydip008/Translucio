            ...
            <div class="col-md-12 text-center">
              ...
              <div class="col-lg-3 col-md-12 p-r">
                <div class="my-profile-left">
                  ...
                  <?php else: ?>
                  <div class="people people-profile-img"><img src="assets/images/dummy.jpg" class="img-responsive"></div>
                  <?php endif; ?>
                ...
                <div class="part_2">
                  ...
                  <div><label>Location:</label> <span><?php echo e(Auth::user()->city); ?></span></div>
                </div>

                <div class="part_3">
                  <h3 class="overview_title">My Profile</h3>
                  <button type="button" onclick="location.href='<?php echo e(route('my_profile')); ?>';" class="btn_personal_information"><img src="assets/images/card/user.png" class="img-responsive">My Profile</button>
                  <button type="button" onclick="location.href='<?php echo e(route('change_password')); ?>';" class="btn_change_information"><img src="assets/images/card/lock1.png" class="img-responsive">Change Password</button>
              ...
              <div class="col-lg-9 col-md-12">
                <div class="my-profile-right">
                   ...
                   <div class="password-left">
                    ...
                    <form action="<?php echo e(url('/change-password-process')); ?>" method="post">
                    <?php if($errors->any()): ?>
                  ...
                  <?php endif; ?> 
                   ...
                   <div class="password-right">
                    ...
                    <div class="col-md-12 text-center">
                      ...
                      <a href="<?php echo e(route('home')); ?>"><button type="button" class="btn_submit_profile btn_can">Cancel</button></a>
                      </div>
                    </div>
                </div>
                </form>
...
<?php echo $__env->make('layouts.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\XAMPP1\htdocs\translucio\translucio\resources\views/user/change_password.blade.php ENDPATH**/ ?>